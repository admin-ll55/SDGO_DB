...
function ch_l(l) {
  ...
  $("label.not[localization]").each(function(){
    $(this).attr("tit", $(this).attr(l)).mousemove(function(e){
...
?>
  $("img.unit").each(function(){
    if ($(this).attr("srcc") != undefined)
      $(this).attr("src", "img/unit/"+$(this).attr("srcc")+".gif");
  });
  $("img.weapon").each(function(){
    $(this).attr("src", "img/weapon/weapon_"+$(this).attr("srcc")+".gif");
  });
  $("img.pos").each(function(){
    $(this).attr("src", "img/pos/"+$(this).attr("srcc")+".jpg");
  });
  $("img.skill, img.sp").each(function(){
    if ($(this).attr("srcc") != "")
      $(this).attr("src", "img/skill/"+$(this).attr("srcc")+".gif");
    else
      $(this).remove();
  });
  $("img.origin").each(function(){
    $(this).attr("src", "img/origin/"+$(this).attr("srcc")+".png");
  });
<?php
  }
  else {
...
?>
  var index = window.location.href.match(/id=([0-9]{5})$/);
  if (index == null) {
    return;
  }
  index = unit[0].indexOf(index[1]);
  document.addEventListener("keydown", function(e){
    if (e.keyCode == 37) {
      if (unit[0][index-1] != undefined) {
        window.location.href = window.location.href.replace(/[0-9]{5,5}/, unit[0][index-1]);
      }
      return false;
    }
    if (e.keyCode == 39) {
