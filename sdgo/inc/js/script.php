...
function ch_img(c) {
<?php
  if (preg_match("/^(127\.0\.0\.1|::1)$/", $_SERVER["REMOTE_ADDR"])) {
?>
  ...
  $("img.pos").each(function(){
    $(this).attr("src", "img/pos/"+$(this).attr("srcc")+".png");
  });
...
function add_tit(c) {
  ...
  $("svg[localization]").mousemove(function(e){
  ...
  $("label.not[localization]").mousemove(function(e){
    $("div#tooltip").text($(this).attr("tit")).css({"top":e.pageY+30+"px", "left":(e.pageX<=$("div#tooltip").outerWidth()/2?0:(window.innerWidth-e.pageX<=$("div#tooltip").outerWidth()/2?window.innerWidth-$("div#tooltip").outerWidth():e.pageX-$("div#tooltip").outerWidth()/2))+"px"}).show();
  }).mouseout(function(){
    $("div#tooltip").hide().css({"left":"0"});
  });
...
$(document).ready(function(){
  ...
  $("label.not").click(function(){($(this).children("input")[0].checked?$(this).addClass("checked"):$(this).removeClass("checked"));setTimeout(function(){$("div#tooltip").fadeOut();},1000);});
  ...
  document.addEventListener("keydown", function(e){
    ...
    machine = parseInt(machine)||false;
    if (e.keyCode == 37) {
      if (index !== false && unit[0][index-1] != undefined) {
        window.location.href = window.location.href.replace(uid[1], unit[0][index-1]);
      }
      if (machine && machine-1 > 0) {
        window.location.href = window.location.href.replace(machine, machine-1);
      }
      return false;
    }
    if (e.keyCode == 39) {
