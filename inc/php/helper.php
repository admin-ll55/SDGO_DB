<form id="settings">
  ...
  <div id="TC" localization text="繁" onclick="setcookie('l', 'TC');"></div>
  <div id="SC" localization text="简" onclick="setcookie('l', 'SC');"></div>
  <br>
  <img src="https://s2.ax1x.com/2019/01/23/kVwmvQ.png" srcc="magnifier.png" width="32" height="32"><br>
  <div id="fs20" localization text="大" onclick="setcookie('fs', '20');"></div>
  <div id="fs18" localization text="中" onclick="setcookie('fs', '18');"></div>
  <div id="fs16" localization text="小" onclick="setcookie('fs', '16');"></div>
</form>
